...
describe("auditAllowanceList (iter606)", () => {
  const cfg: Config = {
    ...
    safety: { enabled: true, transferAllowlistOnly: false, maxSlippageBps: 500, allowInfiniteApprovals: false, tradeApproval: { enabled: false, thresholdUsd: null, expiresMinutes: 60 } },
    webhooks: {},
