...
const RETENTION_TABLES: Array<{
  ...
  { table: "notification_queue", daysField: "notificationQueueDays", pruneFn: pruneNotificationQueue },
  { table: "config_history", daysField: "configHistoryDays", pruneFn: pruneConfigHistory },
