      ...
      try {
        return ok(
          await runTool("incident_report", rt.opts, input, undefined, async () => {
            ...
            return await gatherIncidentReport({
              windowLabel,
