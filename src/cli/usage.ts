...
STATEFUL SAFETY
  ...
  safety size-by-risk (--risk-usd N | --risk-pct N --portfolio-usd N) (--stop-pct N | --trail-pct N) [--token T] [--quote Q] [--price USD] [--quote-price-usd USD] [--direction buy|sell] [--strategy TAG] [--account L] [--chain X] [--json]
